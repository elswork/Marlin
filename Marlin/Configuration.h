...
#define STRING_CONFIG_H_AUTHOR "(Eloy Lopez, V1.3.1)" // Who made the changes.
...
#define MACHINE_UUID "3dc095d9-f394-476b-b8e6-980c09541043"
...
#define DELTA
  ...
  #define DELTA_SEGMENTS_PER_SECOND 150 // Default 200
  ...
  #define DELTA_PRINTABLE_RADIUS 85.0     // (mm) 90

  // Maximum reachable area
  #define DELTA_MAX_RADIUS       90.0     // (mm) 90
  ...
  #define DELTA_RADIUS 105.6              //  105.2(mm) Get this value from G33 auto calibrate
...
#define CLASSIC_JERK
  ...
  #define DEFAULT_XJERK 10.0 // Anterior 20.0
